...
class TestNoTeacherForSubject:
    ...
    def test_same_subject_multiple_levels_reported_once(
        ...
        curriculum = [
            CurriculumEntry("6ème", "Mathématiques", 60, "auto",
                            min_session_minutes=60, max_session_minutes=60),
            CurriculumEntry("5ème", "Mathématiques", 60, "auto",
                            min_session_minutes=60, max_session_minutes=60),
        ]
        sd = _make_sd(
            base_tc, base_school,
...
class TestSoleTeacherOverload:
    def test_overloaded_sole_teacher_detected(
        ...
        entry = CurriculumEntry(
            level="6ème", subject="Mathématiques",
            total_minutes_per_week=240, mode="auto",  # 4h
            min_session_minutes=60, max_session_minutes=60,
        )
        sd = _make_sd(
            base_tc, base_school,
    ...
    def test_overloaded_fix_includes_increase_hours(
        ...
        entry = CurriculumEntry(
            level="6ème", subject="Mathématiques",
            total_minutes_per_week=240, mode="auto",
            min_session_minutes=60, max_session_minutes=60,
        )
        sd = _make_sd(
            base_tc, base_school,
...
class TestClassHoursExceedSchedule:
    def test_overflow_detected(
        ...
        entry = CurriculumEntry(
            level="6ème", subject="Mathématiques",
            total_minutes_per_week=1500, mode="auto",  # 25h
            min_session_minutes=60, max_session_minutes=60,
        )
        sd = _make_sd(
            base_tc, base_school,
    ...
    def test_within_schedule_no_report(
        ...
        entry = CurriculumEntry(
            level="6ème", subject="Mathématiques",
            total_minutes_per_week=600, mode="auto",  # 10h, well within 20h
            min_session_minutes=60, max_session_minutes=60,
        )
        sd = _make_sd(
            base_tc, base_school,
    ...
    def test_fix_includes_reduce_curriculum(
        ...
        entry = CurriculumEntry(
            level="6ème", subject="Mathématiques",
            total_minutes_per_week=1500, mode="auto",
            min_session_minutes=60, max_session_minutes=60,
        )
        sd = _make_sd(
            base_tc, base_school,
